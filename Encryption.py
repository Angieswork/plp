...
class EncryptionHelper:
    def __init__(self):
        ...
        self.ciphor = Fernet(self.key)

    def encrypt(self, data):
         return self.ciphor.encrypt(data.encode()).decode()

    def decrypt(self, data):
         return self.ciphor.decrypt(data.encode()).decode()
# Base Person Class
class Person:
...
# Treatment Class (with polymorpism)
class Treatment:
...
if __name__ == "__main__":
    ...
    #Demonstrating Nurse requesting treatment
